...
import static Vista.VistaGerente.parent;
...
public final class GuardarExcel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TipoCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una opción...", "Plantas disponibles", "Plantas disponibles (detallado)", "Todas las plantas (detallado)" }));
    ...
    private void btnGuardarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarExcelActionPerformed
        ...
        if (VistaGerente.Inventario.isShowing()) {
            ...
            if (txfRuta.getText().length() == 0) {
                ...
                switch (tipo) {
                    ...
                    case "Plantas disponibles":
                        ...
                        dispose();
                        break;
                    case "Plantas disponibles (detallado)":
                        generar.crearExcelDisponiblesDetallado(txfRuta.getText());
                        JOptionPane.showMessageDialog(null, "El archivo se ha guardado y se abrirá en breve...");
                        txfRuta.setText(null);
                        TipoCombo.setSelectedIndex(0);
                        dispose();
                        break;
                    case "Todas las plantas (detallado)":
    ...
    public void guardarExcelSalida() {
        ...
        try {
            ...
            if (txfRuta.getText().length() == 0) {
                ...
                Calendar fecha1 = VistaGerente.fechaDesdeSalida.getCalendar();
                Calendar fecha2 = VistaGerente.fechaHastaSalida.getCalendar();
                ...
                String motivo = VistaGerente.motivoComboConsultarSalida.getSelectedItem().toString();
                String cedula = VistaGerente.txfBuscarConsultarSalida.getText();
                ...
                if (VistaGerente.tablaConsultarSalidas.getRowCount() == 0) {

                    JOptionPane.showMessageDialog(null, "No hay ninguna salida para mostrar, por favor busque alguna salida.");

                } else if (VistaGerente.tablaConsultarSalidas.getSelectedRow() == -1 && VistaGerente.txfBuscarConsultarSalida.getText().length() == 0) {
                ...
                } else if (VistaGerente.tablaConsultarSalidas.getSelectedRow() != -1) {

                    generar.crearExcelSalidasEspecifico(txfRuta.getText(), VistaGerente.tablaConsultarSalidas.getValueAt(VistaGerente.tablaConsultarSalidas.getSelectedRow(), 0).toString());
                    JOptionPane.showMessageDialog(null, "El archivo se ha guardado y se abrirá en breve...");
                    txfRuta.setText(null);
                    dispose();
                }
