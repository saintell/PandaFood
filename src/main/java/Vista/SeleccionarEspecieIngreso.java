...
public final class SeleccionarEspecieIngreso extends javax.swing.JFrame {
    ...
    public void seleccionarEspecie() {
        ...
        VistaGerente.txfEspecie.setText(nombre_vulgar);
        VistaGerente.codigo_Especie = Integer.parseInt(tablaEspecies.getValueAt(tablaEspecies.getSelectedRow(), 0).toString());
        VistaGerente.rangoCombo.setSelectedIndex(-1);
        dispose();
