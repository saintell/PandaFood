...
public final class SeleccionarReserva extends javax.swing.JFrame {
                    ...
                    if (resultado == 0) {
                        ...
                        if (rs.next()) {
                            ...
                            if (cedula.contains("-")) {
                                ...
                                VistaGerente.IdentificacionComboSalidas.setSelectedIndex(2);
                                VistaGerente.IdentificacionComboSalidas.setEnabled(false);
                            } else {

                                VistaGerente.IdentificacionComboSalidas.setSelectedIndex(1);
                                VistaGerente.IdentificacionComboSalidas.setEnabled(false);

                            }

                            VistaGerente.txfIdentificacionClienteSalidas.setText(cedula);
                            VistaGerente.txfNombreClienteSalidas.setText(rs.getString(3));
                            VistaGerente.txfTelefonoClienteSalidas.setText(rs.getString(4));
                            VistaGerente.txfIdentificacionClienteSalidas.setEnabled(false);
                            VistaGerente.txfNombreClienteSalidas.setEnabled(false);
                            VistaGerente.txfTelefonoClienteSalidas.setEnabled(false);
                            VistaGerente.codigo_Reserva = codigo_reserva;
                            seleccionarReserva();
                            dispose();
    ...
    public void mostrarEspeciesReservadas() {
        ...
        try {
            ...
            TableColumnModel column = VistaGerente.tablaSalidas.getColumnModel();
            DefaultTableCellRenderer tcr = new DefaultTableCellRenderer();
            VistaGerente.tablaSalidas.setModel(modelo);
            tcr.setHorizontalAlignment(SwingConstants.LEFT);
            column.getColumn(1).setPreferredWidth(200);
