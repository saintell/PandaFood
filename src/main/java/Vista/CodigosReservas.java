        ...
        try {
            ...
            if (evt.getClickCount() == 1) {
                ...
                if (rs.next()) {
                    ...
                    VistaGerente.txfCodigoReserva.setText(rs.getString(1));
                    VistaGerente.txfIdentificacionConsultarReservas.setText(rs.getString(2));
                    VistaGerente.txfNombreConsultarReservas.setText(rs.getString(3));
                    VistaGerente.txfTelefonoConsultarReservas.setText(rs.getString(4));
